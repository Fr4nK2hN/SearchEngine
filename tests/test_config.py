...
class ConfigTests(unittest.TestCase):
    def test_service_defaults_match_current_runtime(self):
        ...
        self.assertEqual(config.adaptive_hard_mode, "ltr")
        self.assertEqual(config.ltr_model_path, "models/ltr_model_manual.pkl")
        self.assertEqual(config.query_router_model_path, "models/query_router_retrieval.pkl")
        self.assertEqual(config.adaptive_hard_threshold, 0.60)
