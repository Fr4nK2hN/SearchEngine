...
def main():
    ...
    effective_current_ce_depth = (
        min(current_ce_depth, ADAPTIVE_HARD_TOP_K_CAP)
        if ADAPTIVE_HARD_TOP_K_CAP is not None
        else current_ce_depth
    )
    ...
    output = {
        ...
        "current_hard_top_k": effective_current_ce_depth,
        "model_hard_top_k": current_ce_depth,
